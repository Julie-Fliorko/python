...
class fork(abstract_tableware, ABC):
    def __init__(self, garantee_in_days: int, style: str, How_to_wash: how_to_wash, wieght_in_grams: int, ability_to_microwave: bool,
                 manufacturer: str, colour: str, dessigned_for: str, material: str, tableware_type: TablewareType, price: int, diameter_in_cm: int, heandle_length_in_cm: int) -> None:
        ...
        self.heandle_length_in_cm = heandle_length_in_cm
